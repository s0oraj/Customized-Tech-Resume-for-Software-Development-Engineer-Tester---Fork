      ...
      <div className="bg-gray-900 p-4 rounded mt-3">
        ...
        <ul className="space-y-1">
          <li className="flex items-start text-xs text-gray-400">
            ...
            <span>
              Formulated an NLP model using TensorFlow and Keras regression with
              ReLU activation to predict product length on regression analysis
              on Amazon dataset of 2.2 million products to enhance packaging and
          ...
          <li className="flex items-start text-xs text-gray-400">
            <span className="text-[#5DC22D] mr-2 mt-0.5">•</span>
            <span>
              Optimized text vectorization (vocab size: 10,000, max sequence
              length: 200 tokens) achieved excellent training loss: 0.38121589
              and validation loss: 0.31848289.
            </span>
          </li>
        </ul>
      </div>
